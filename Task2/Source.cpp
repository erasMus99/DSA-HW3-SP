...
// Modified to fit the DSA homework 3.
...
template <size_t ROW, size_t COL>
void display(const array<array<int, COL>, ROW>& grid, Pair p)
{
...
void tracePath(
	...
	const Pair& dest, const array<array<int, COL>, ROW>& grid)
{
	stack<Pair> Path;
...
template <size_t ROW, size_t COL>
void create_grid(array<array<int, COL>, ROW>& grid)
{
    srand(time(nullptr));
